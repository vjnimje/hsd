    	...
    	<div class="container">
    		<div class="row">
    				...
    				<div class="request-quote">
                      ...
                      <select name="" id="" class="form-control" required/>
                        ...
                        <option value="Other">Other</option>
	    					...
	    					<div class="form-group">
		              <textarea name="" id="" cols="30" rows="2" class="form-control" placeholder="Message" required/></textarea>
		            </div>
		            <div class="form-group">
	          ...
	          <div class="heading-section mb-5">
	            <h2 class="mb-4">Welcome to HSD Engineering Co.</h2>
	          </div>
	          <div class="">
							<p class="mb-5" align="justify">Over the years, HSD Engineering Co. has grasped the spirit of industries from the very day we began to supply parts and services to the nearby mining facilities. The values which we possess are integrity, reliability, innovation and customer focus which has earned us the goodwill in the domestic and international markets.</p>
							<p><a href="<?php echo base_url()?>about" class="btn btn-secondary px-5 py-3">Read More</a></p>
						</div>
					</div>
    		</div>
    	</div>
    ...
    <section class="ftco-services ftco-no-pt">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>We also service / repair sub assemblies.</p>
          </div>
        </div>
				<div class="row">
          ...
          <div class="col-md-2 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
            		<img src="<?php echo base_url();?>assets/fonts/flaticon/font/transmission.svg">
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Transmissions</h3>
              </div>
            </div>    
          </div>
          <div class="col-md-2 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
            		<img src="<?php echo base_url();?>assets/fonts/flaticon/font/hydraulic.svg">
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Hydraulic</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-2 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
            		<img src="<?php echo base_url();?>assets/fonts/flaticon/font/valve.svg">
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Valves</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-2 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
            		<img src="<?php echo base_url();?>assets/fonts/flaticon/font/cylinder.svg">
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Cylinders</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-2 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
            		<img src="<?php echo base_url();?>assets/fonts/flaticon/font/search.svg">
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">ETC..</h3>
              </div>
            </div>      
          </div>
        </div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-9 text-center">
						...
						<p>We Import & Stock Quality Parts for Mining & Earthmoving Equipment</p>
						<p class="mb-0"><a href="<?php echo base_url();?>about" class="btn btn-primary px-4 py-3">Know more about us</a></p>
					</div>
				</div>
			</div>
		</section>
