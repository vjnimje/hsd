    ...
    <section class="ftco-section">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url(assets/images/machines/machines.jpg);">
					</div>
					<div class="col-md-7 wrap-about py-5 px-4 px-md-5 ftco-animate">
	          <div class="heading-section mb-5">
	            <h5 class="mb-4">We Are Expert in service / repair sub assemblies.</h2>
	          </div>
	          <div class="">
							<ul>
                  <li>Engines</li>
