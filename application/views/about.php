    <section class="hero-wrap hero-wrap-2" style="background-image: url('assets/images/bg/bg7.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section">
			<div class="container">
	          ...
	          <div class="heading-section mb-5">
	            <h2 class="mb-4">We Are Highly Recommendable Engineering Co.</h2>
	          </div>
	          <div class="">
							<p align="justify">We enjoy the trust and confidence of our customers. Replacement parts marketed by us do not have to mean replacement quality. We try and ensure that every part we sell has been built to the performance specifications required for the most rugged applications. We want to ensure that our customers get the parts they want, the performance they need and the value they deserve.</p>
							<h5>CONVENIENT ONE-STOP SOURCE</h5>
							<p align="justify">We are able to provide efficient, fast and reliable service as our warehousing, distribution and office operations are consolidated under one roof in HSD Engineering Co.</p>
						</div>
					</div>
				</div>
				<div class="row no-gutters">
